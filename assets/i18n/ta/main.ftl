...
# ── SG பொது பேருந்து ─────────────────────────────────────────────────────────────
title-mode-sg            = SG பொது பேருந்து
title-switch-hint-sg     = [Tab] SG பொது பேருந்து
title-switch-hint-nus    = [Tab] NUS வளாகம்

sg-panel-stops-title    = SG பேருந்து நிறுத்தங்கள்
sg-panel-stops          = பேருந்து நிறுத்தங்கள் ({ $count })
sg-panel-favs           = ★ பிடித்தவை ({ $count })
sg-stops-loading        = பேருந்து நிறுத்தங்கள் ஏற்றுகிறது... ({ $count } ஏற்றப்பட்டன)
sg-stops-error          = ஏற்றுவதில் தோல்வி: { $message }

sg-detail-no-service    = இந்த நிறுத்தத்தில் பேருந்துகள் இல்லை.
sg-detail-loading       = வருகை தகவல் பெறுகிறது...
sg-detail-no-data       = தரவு இல்லை.  [r] அழுத்துக.
sg-detail-error         = ! { $message }

sg-col-bus   = பேருந்து
sg-col-opr   = நிறுவனம்
sg-col-next  = அடுத்தது
sg-col-2nd   = பின்னது
sg-col-load  = நிரப்பு
sg-col-type  = வகை

settings-mode-label  = இயல்புநிலை பயன்முறை:
settings-mode-nus    = [NUS வளாகம்]
settings-mode-sg     = [SG பொது பேருந்து]

status-mode-sg  = SG பொது பேருந்துக்கு மாற்றப்பட்டது
status-mode-nus = NUS வளாகத்துக்கு மாற்றப்பட்டது

footer-normal-sg = [↑↓/j/k] நகர்த்து   [f] பிடித்தவை   [r] புதுப்பி   [/] தேடு   [Tab] NUS   [s] அமைப்புகள்   [q] வெளியேறு
